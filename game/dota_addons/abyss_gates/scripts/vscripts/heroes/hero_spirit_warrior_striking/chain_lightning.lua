function LightningJump ( event )
	...
	local stackCount = caster:GetModifierStackCount( "modifier_storm_strike_charge", ability)
	...
	if stackCount > 0 then
		caster:SetModifierStackCount("modifier_storm_strike_charge", ability, stackCount - 1)
